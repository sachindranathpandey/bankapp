...
const depositMoreThank = bankDepositSum
  .filter(acc => acc >= 1000)
  .reduce((count, cur) => (cur >= 1000 ? ++count : count), 0);
console.log(depositMoreThank);

// Exercise 3 , Advanced use case of reduce method
...
const getFirstLetterCap = function (str) {};

const str = 'hello how are you'.slice();
console.log(str);
